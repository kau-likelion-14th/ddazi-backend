...
public class FollowController {
    ...
    @DeleteMapping
    @Operation(summary = "언팔로우", description = "json 요청에 유저아이디를 전달해주면 언팔로우를 수행합니다.")
    ...
    @GetMapping
    @Operation(summary = "팔로우 가능한 유저를 페이징 조회합니다.")
    public ApiResponse<Page<FollowUserResponse>> getCanFollows(
            @RequestParam Long userId,
    ...
    @GetMapping("/search")
    @Operation(summary = "팔로우 가능한 유저를 검색합니다. 쿼리 파라미터로 page, size, sort를 전달할 수 있습니다.  ")
